      ...
      {user && (
        <div className="flex-grow flex justify-end">
          ...
          <div className="text-white p-2 flex">
            ...
            <img
              className="w-12 ml-2 rounded-full mx-2"
              alt="UserIcon"
              src={user?.photoURL}
            />
            <select
              className="text-white bg-transparent border-none rounded-lg w-4  text-center"
              onChange={handleSignOut}
              defaultValue=""
            >
              <option className="text-g border-none bg-black" value="" disabled></option>
              <option className="border-none my-8 text-2xl bg-black" value="logout">
                Logout
              </option>
            </select>
          </div>
